...
export default function Footer() {
  return (
    <footer className="bg-chocolate text-white py-16">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/80 text-lg mb-6 max-w-md">
              Creating Baci Moments Daily. Natural, gluten-free gelato crafted with 
              traditional Italian techniques in the heart of Sofia.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#desserts" className="text-white/80 hover:text-white transition-colors">
                  Desserts
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-white/60 text-sm">
              © 2024 Atelier del Gelato. All rights reserved.
            </div>
        ...
        <div className="mt-8 p-6 bg-white/5 rounded-2xl text-center">
          <p className="text-white/80 text-lg font-medium mb-2">
            🍨 Thank you for choosing Atelier del Gelato! 🍨
          </p>
